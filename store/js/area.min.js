...
function getCitys(scid, spid,vc) {
	...
	if (sc.options.length == 1) {
		sc.parentNode.style.display = 'inline-block';
	}else {
...
function chgProvinces(sp, sc, sa) {
	...
	if(str != "四川省"){
		...
		console.log(map,marker1,marker2,marker3,marker4)
...
function AreaCtrl(strP,strC,strA){
	...
	this.html = '<span>'+'<select name="Province" id="prov'+this.randomNum+'" '+onchgProvincesStr+' ></select></span>';
	if (this.level>1){this.html += '<span>'+'<select name="City" id="city'+this.randomNum+'" '+onchgCityStr+' ></select></span>';}					
